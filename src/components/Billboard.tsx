  ...
  return (
   <div className = "relative h-[56.25vh]">
    ...
    <div className = "absolute top-[30%] md:top-[40%] ml-4 md:ml-16">
      <h1 className = "text-white  font-bold md:text-5xl h-full w-[50%] lg:text-6xl drop-shadow-xl"> {title}</h1>
      <p className = "text-white  font-semibold text-[8px] md:text-lg mt-3 md:mt-8 w-[90%] md:[80%] lg:w-[50%]"> {description}</p>
