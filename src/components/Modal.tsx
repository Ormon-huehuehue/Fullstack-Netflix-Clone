...
const Modal = ({handleClose, movieId, title, description, thumbnail, url}:ModalProps)=>{
  ...
  return (
    ...
    >
        ...
        {/* Content Section */}
        <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-zinc-900 via-zinc-900/95 to-transparent">
            <div className="p-6 pb-8 space-y-4">
                <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-white leading-tight font-montserrat">
                    {title}
                </h2>
                <p className="text-gray-300 text-sm md:text-base leading-relaxed max-w-2xl font-montserrat">
                    {description}
                </p>
            </div>
        </div>
